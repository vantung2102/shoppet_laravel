...
<section class="section-slide">
    <div class="wrap-slick1 rs1-slick1">
        <div class="slick1">
            <div class="item-slick1" style="background-image: url({{asset('client/images/1.jpg')}});">
            ...
            <div class="item-slick1" style="background-image: url({{asset('/client/images/banner/2.jpg')}});">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30">
            ...
            <div class="item-slick1" style="background-image: url({{asset('client/images/5.jpg')}});">
                <div class="container h-full">
                    <div class="flex-col-l-m h-full p-t-100 p-b-30">
