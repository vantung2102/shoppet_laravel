        ...
        <div class="select-input">
          ...
          <ul class="select-input__list">
            <li class="select-input-item">
              <a href="{{request()->fullUrlWithQuery(['price']=>'desc')}}" class="select-input__link">Giá : Thấp đến cao</a>
            </li>
            <li class="select-input-item">
              <a href="{{request()->fullUrlWithQuery(['price']=>'asc')}}" class="select-input__link">Giá : Cao đến thấp</a>
            </li>
          </ul>
        </div>
      </div>
