@extends('client.layout.default') @section('content')
...
<div class="detail-product" id="detail-product">
    <div class="grid wide">
        <div class="detail-product__link">
            ...
            <a
                class="detail-product__link-Products"
                href="/danh-muc/{{$product->menu->id}}-{{Str::slug($product->menu->name)}}.html"
                >{{$product->menu->name}}</a
            >
        </div>
                ...
                <div class="col l-5 m-5 c-12">
                    <div class="product-detail__illustration">
                        <div class="product-detail__illustration-img">
                            <img
                                ...
                                class="
                                    product-detail__illustration-img-main
                                    data-img
                                "
                                id="img-main"
                                data-img=""
                            ...
                            <div class="product-detail__illustration-img-show">
                                <img
                                    src="{{$product->thumbnail}}"
                                    class="
                                        product-detail__illustration-img-item
                                    "
                    ...
                    <div class="product-detail__illustration-share">
                        <div class="product-detail__illustration-share-link">
                            <div
                                class="
                                    product-detail__illustration-share-link-text
                                "
                            >
                                Chia sẻ:
                            </div>
                            ...
                            <div
                                class="
                                    product-detail__illustration-share-link-internet
                                "
                            >
                                <a
                                    class="
                                        product-detail__illustration-share-link-item
                                    "
                                    type="button"
                                    role="button"
                        ...
                        <div class="product-detail__illustration-like">
                            <div
                                class="
                                    product-detail__illustration-like-sperate
                                "
                            >
                                |
                            </div>
                    ...
                    <div class="product-detail__infor">
                        <div class="product-detail__infor-title">
                            ...
                            <div class="product-detail__infor-title-review">
                                <div
                                    class="
                                        product-detail__infor-title-review-link
                                    "
                                >
                                    <div
                                        class="
                                            product-detail__infor-title-review-link-star
                                        "
                                    >
                                        <a href="">5.0</a>
                                    </div>
                                    <div
                                        class="
                                            product-detail__infor-title-review-star
                                        "
                                    >
                                        <i
                                            class="
                                    ...
                                    <div
                                        class="
                                            product-detail__infor-title-review-sparate
                                        "
                                    >
                                        |
                                    </div>
                            ...
                            <div class="product-detail__infor-select">
                                <div class="product-detail__infor-select-price">
                                    <div
                                        class="
                                            product-detail__infor-select-price-old
                                            price-old
                                        "
                                        data-old_price=""
                                    >
                                    ...
                                    <div
                                        class="
                                            product-detail__infor-select-price-new
                                            price-new
                                        "
                                        data-new_price=""
                                    >
                                ...
                                <div
                                    class="
                                        product-detail__infor-select-transport
                                    "
                                >
                                    <p>Vận chuyển</p>
                                    <div
                                        class="
                                            product-detail__infor-select-transport-fee
                                        "
                                    >
                                        <p>
                                        ...
                                        <p class="color-opacity">
                                            Miễn phí vận chuyển cho hóa đơn trên
                                            500.000đ
                                        </p>
                                    </div>
                                </div>
                                <form action="/add-cart" method="post">
                                    <div class="product-detail__infor-select-amount">
                                        <div class="product-detail__infor-select-amount-infor">
                                            ...
                                            <div
                                                class="
                                                    product-detail__infor-select-amount-infor-ready
                                                "
                                            >
                                                12 sản phẩm có sẵn
                                            </div>
                                    ...
                                    <div class="product-detail__infor-select-cart">
                                        <button type="submit" class="bag-btn cart" data-id="">
                            ...
                            <div class="product-detail__infor-description-add">
                                <div
                                    class="
                                        product-detail__infor-description-title
                                    "
                                >
                                ...
                                <div
                                    class="
                                        product-detail__infor-description-container
                                    "
                                >
                                    <div
                                        class="
                                            product-detail__infor-description-container-item
                                        "
                                    >
                                        <div
                                            class="
